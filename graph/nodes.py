...
def reporter_node(state: State, config: RunnableConfig):
    ...
    # Ensure it ends with .md and replace spaces with underscores if preferred, currently keeping spaces is usually fine but let's stick to simple sanitization
